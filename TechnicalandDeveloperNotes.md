...
The Seneca member was not included in the sprint planning meetings with UDC and planned documentation tasks separately. However, through Taiga, email, MS Teams, Zoom, and with the help of Google Translate, all team members were able to communicate about their planned tasks and answer questions and share information in a transparent and timely way. 
...
| Increment                                               | Tasks completed                                                                             | Notes                                                       |
|:-------------------------------------------------------:|:-------------------------------------------------------------------------------------------:|:-----------------------------------------------------------:|
| Creation of a Functional Test plan before release       | Create spreadsheet for functional test plan                                                 | See [Functional Test Plan](#functional-test-plan) below. To be updated prior to LRM App v.1.0 release on 3 December 2024                                                          |
...
For reference, the [Functional Test Plan for the LRM App](/images/Pruebas_Manuales_25NOV2024.pdf) as of 25 November 2024 (in the original Spanish) is included with these notes. 
