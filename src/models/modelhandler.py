...
class ModelHandler:
    ...
    def train_model(self, data, input_columns, output_column, description = "No description provided"):
        ...
        Args:
            ...
            input_columns (list): Feature columns
            output_column (str): Target column
            description (str): Model description
        """
        X = data[input_columns].values
        y = data[output_column].values

        #Divides data in training / testing
        ...
        # Save coefficients, intercept and formulas
        ...
        if len(self.input_columns) == 1 and X_test.shape[1] == 1:
            self.plot_data = (X_test[:, 0], y_test, y_pred)
    ...
    def save_model(self, file_path):
        ...
        Args:
            file_path (str): Path there model will be saved
    ...
    def make_prediction(self, input_fields):
        ...
        Args:
            input_fields: Includes values filled by the user.
